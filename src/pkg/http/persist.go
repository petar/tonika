...
// Pending returns the the number of successfully read requests
// minus the number of successfully sent responses.
...
// Pending returns the the number of successfully sent requests
// minus the number of successfully read responses.
